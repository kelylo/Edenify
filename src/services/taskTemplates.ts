...
const EXTRA_LAYER_TEMPLATES: Record<LayerId, string[]> = {
  spiritual: [
    'Morning prayer 5 minutes',
    'Read Bible one chapter',
    'Short gratitude prayer night',
    'Pray before starting work',
    'Memorize one Bible verse daily',
    'Read one Christian book page',
    'Replace bad habit with short prayer',
    'Avoid idle scrolling alone',
  ],
  academic: [
    "Review today's lectures before class",
    'Revise yesterday notes 10 minutes',
    'Summarize lecture into one page',
    'Practice past exam questions daily',
    'Learn one software skill daily',
    'Practice coding 30 minutes',
    'Build small project weekly',
    'Fix one bug daily',
  ],
  financial: [
    'Track daily expenses',
    'Save small amount daily',
    'Avoid unnecessary purchases',
    'Learn one money concept daily',
    'Review spending leaks',
    'Focus on skill building over comfort',
    'Set weekly money check-in',
    'Update budget before weekend',
  ],
  physical: [
    'Wake up without snooze',
    'No phone first 30 minutes morning',
    'Daily gym 30 minutes minimum',
    'Pushups after waking up',
    'Stretch after study session',
    'Walk 10 minutes after meals',
    'Sleep at same time daily',
    'Drink water before coffee',
  ],
  general: [
    'Plan top 3 tasks today',
    'Track daily wins checklist',
    'Clean desk before study session',
    'Prepare bag night before',
    'Start task immediately 5 second rule',
    'Do smallest possible next step',
...
const buildAllTemplates = (): EdenTemplate[] => {
  ...
  const processLayer = (
    ...
    // Surface the most useful templates first, then fill from the broader pool.
    const limitedTaskNames = [...EXTRA_LAYER_TEMPLATES[layerId], ...taskNames].slice(0, 8);
